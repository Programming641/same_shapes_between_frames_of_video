...
py algorithms/preparation/evaluate_images.py $directory
If($LASTEXITCODE -eq 1){
   echo "error occurred in algorithms/preparation/evalulate_images.py"
...
py algorithms/pixch/execute_scripts.py $directory
If($LASTEXITCODE -eq 1){
   echo "error occurred in algorithms/pixch/execute_scripts.py"
   echo uuuuuuuuuuy | choice
   exit
}
...
<#
py algorithms/new/execute_scripts.py $directory
If($LASTEXITCODE -eq 1){
   echo "error occurred in algorithms/new/execute_scripts.py"
   echo uuuuuuuuuuy | choice
   exit
}
#>
