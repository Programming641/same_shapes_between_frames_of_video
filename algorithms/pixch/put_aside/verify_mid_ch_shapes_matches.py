from libraries import pixel_functions, read_files_functions, pixel_shapes_functions, image_functions, shapes_results_functions, btwn_amng_files_functions
...
verified_matches = shapes_results_functions.verify_matches( mid_ch_shapes, [ im1shapes, im2shapes ], [ im1shapes_colors, im2shapes_colors ], 
                   [ im1shapes_neighbors, im2shapes_neighbors ], im_width, min_colors  )
