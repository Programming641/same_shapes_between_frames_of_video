...
max_progress_num = len( im2pixch_shapes )
cur_progress_num = len( im2pixch_shapes )
prev_progress_num = len( im2pixch_shapes )
remaining_chars = ""
for im2pixch_shape in im2pixch_shapes:
   ...
   for im2vicinity_pixel in im2vicinity_pixels:
      ...
      im1shapes_in_vicinity.add( im1shape_by_pindex[ im2pindex ] )
      ...
      for im1shape_in_vicinity in im1shapes_in_vicinity:
         ...
         if matched_im1shape is None:
            ...
            if min_colors is True:
               ...
               appear_diff = pixel_functions.compute_appearance_difference(im2shapes_colors[im2pixch_shape], im1shapes_colors[im1shape_in_vicinity] )
            ...
            for im1s_nbr_in_vicinity in im1shapes_in_vicinity:
               ...
               if min_colors is True:
                  ...
                  appear_diff = pixel_functions.compute_appearance_difference(im2shapes_colors[im2pixch_neighbor], im1shapes_colors[im1s_nbr_in_vicinity] )
                  if appear_diff is False:
                     # same appearance
                     color_match = True
